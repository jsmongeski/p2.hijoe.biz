...
# What is the name of this app?
	define('APP_NAME', 'Homebrewbuzz');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@homebrewbuzz.com'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'webmaster@homebrewbuzz.com'); 

# Default DB name for this app
	define('DB_NAME', "p2_hijoe_biz"); 
...
# For this you could use gmail SMTP or something like http://sendgrid.com/
	...
	define('SMTP_USERNAME', 'jsmonges@gmail.com');
	define('SMTP_PASSWORD', 'taichi1gmA');

# For extra security, you might want to set different salts than what the core uses
	//define('PASSWORD_SALT', 'lqsv6Z0SAk3E3SIL5@oIzIz2%i$aEBTIavC8K6AF');
	//define('TOKEN_SALT', '   zqsv6Z0Spbk3E3SIL57oIzIz2qB@EBTIavC8K6AF');
